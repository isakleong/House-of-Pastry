<!-- Navigation -->
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top"> <!--fixed-top / sticky top-->
	<div class="container-fluid">
		<a class="navbar-brand" href="#"> <img src="img/logo1.png" style="width: 100px; height: 80px;">
			<?php 
