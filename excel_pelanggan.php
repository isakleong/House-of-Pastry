...
$excel->setActiveSheetIndex(0)->setCellValue('C3', "ALAMAT"); // Set kolom C3 dengan tulisan "ONGKIR"
$excel->setActiveSheetIndex(0)->setCellValue('D3', "EMAIL"); // Set kolom D3 dengan tulisan "TANGGAL"
$excel->setActiveSheetIndex(0)->setCellValue('E3', "TELEPON"); // Set kolom D3 dengan tulisan "Total"
...
$ambil = $koneksi->query("SELECT * FROM pelanggan where id_pelanggan > 0");
...
while($data = $ambil->fetch_assoc()){ // Ambil semua data dari hasil eksekusi $sql
  ...
  $excel->setActiveSheetIndex(0)->setCellValue('C'.$numrow, $data['alamat_pelanggan']);
  $excel->setActiveSheetIndex(0)->setCellValue('D'.$numrow, $data['email_pelanggan']);
  $excel->setActiveSheetIndex(0)->setCellValueExplicit('E'.$numrow, $data['telepon_pelanggan'], PHPExcel_Cell_DataType::TYPE_STRING);
...
$excel->getActiveSheet(0)->setTitle("Data Pelanggan");
