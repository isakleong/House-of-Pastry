...
$excel->setActiveSheetIndex(0)->setCellValue('C3', "HARGA"); // Set kolom C3 dengan tulisan "HARGA"
$excel->setActiveSheetIndex(0)->setCellValue('D3', "UKURAN"); // Set kolom D3 dengan tulisan "BERAT"
$excel->setActiveSheetIndex(0)->setCellValue('E3', "KATEGORI"); // Set kolom D3 dengan tulisan "BERAT"
$excel->setActiveSheetIndex(0)->setCellValue('F3', "RATING"); // Set kolom D3 dengan tulisan "BERAT"
...
while($data = $ambil->fetch_assoc()){ // Ambil semua data dari hasil eksekusi $sql
  ...
  $excel->setActiveSheetIndex(0)->setCellValue('C'.$numrow, number_format($data['harga_produk']));
  $excel->setActiveSheetIndex(0)->setCellValueExplicit('D'.$numrow, $data['berat_produk'], PHPExcel_Cell_DataType::TYPE_STRING);
  $excel->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $data['nama_kategori']);
  $excel->setActiveSheetIndex(0)->setCellValue('F'.$numrow, $data['rating']);
