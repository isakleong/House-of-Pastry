...
$excel->getProperties()->setCreator('House Of Pastry')
             ...
             ->setTitle("Data Ongkir")
             ->setSubject("Ongkir")
             ->setDescription("Data Ongkir")
             ->setKeywords("Data Ongkir");
...
$excel->setActiveSheetIndex(0)->setCellValue('A1', "DATA ONGKIR"); // Set kolom A1 dengan tulisan "DATA SISWA"
...
$excel->setActiveSheetIndex(0)->setCellValue('C3', "TARIF"); // Set kolom B3 dengan tulisan "Tarif"
...
while($data = $ambil->fetch_assoc()){ // Ambil semua data dari hasil eksekusi $sql
  ...
  $excel->setActiveSheetIndex(0)->setCellValue('B'.$numrow, $data['nama_kota']);
  $excel->setActiveSheetIndex(0)->setCellValueExplicit('C'.$numrow, number_format($data['tarif']));
...
$excel->getActiveSheet(0)->setTitle("Data Ongkir");
$excel->setActiveSheetIndex(0);

// Proses file excel
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment; filename="Data Ongkir.xlsx"'); // Set nama file excel nya
